 ...
 */
function calculateTip(tipPercent, totallBill) {
    return tipPercent * totallBill;
}
 ...
 */
var tipPercent = prompt("How much was your bill?");
var totalBill = prompt("What percentage do you want to tip?");
...
function applyDiscount(priceBefore, discountPercent) {
    return (priceBefore - (priceBefore*discountPercent)).toFixed(2);
}
