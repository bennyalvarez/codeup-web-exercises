(function() {
    ...
    shoppers.forEach(function (shopper) {
        ...
        if (shopper.amount < 200) {
            console.log(shopper.name + " does not get discount.");
        } else {
            console.log("This shopper  " + shopper.name + " spent $" + (shopper.amount).toFixed(2) + ". Therefore," +
                "they get a 12% discount which makes their new price $" + (newPrice).toFixed(2));
        }
    });
    ...
    function createBook(title, authorFirstName, authorLastName) {
        return {
            title: title,
            author: {
                fistName: authorFirstName,
                lastName: authorLastName
            }
        };
    }
    console.log(createBook("Marry Poppins", "P.L", "Travers"));
